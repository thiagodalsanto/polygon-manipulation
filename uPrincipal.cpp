...
__fastcall TForm1::TForm1(TComponent* Owner) : TForm(Owner) {
  ...
  pol.cordenadas3d.push_back(Cordenadas3D(0, mundo.ymax,10));
  pol.cordenadas3d.push_back(Cordenadas3D(0, mundo.ymin,1));

  display.poligonos.push_back(pol);
  pol.cordenadas3d.clear();

  //Horizontal
  pol.id     = contaId++;
  pol.tipo   = 'E';

  pol.cordenadas3d.push_back(Cordenadas3D(mundo.xmin, 0,1));
  pol.cordenadas3d.push_back(Cordenadas3D(mundo.xmax, 0,1));

  display.poligonos.push_back(pol);
  pol.cordenadas3d.clear();

  //Clipping
  pol.cordenadas3d.push_back(Cordenadas3D(clipping.xmin, clipping.ymin,1));
  pol.cordenadas3d.push_back(Cordenadas3D(clipping.xmin, clipping.ymax,1));
  pol.cordenadas3d.push_back(Cordenadas3D(clipping.xmax, clipping.ymax,1));
  pol.cordenadas3d.push_back(Cordenadas3D(clipping.xmax, clipping.ymin,1));
  pol.cordenadas3d.push_back(Cordenadas3D(clipping.xmin, clipping.ymin,1));
	...
	if(!Linha->Enabled){
		...
		if ((rgTipoReta->ItemIndex) >= 0) {
			...
			if (Button ==  mbLeft){
				...
				pol.cordenadas3d.push_back(aux);
...
void __fastcall TForm1::Button1Click(TObject *Sender) {
	...
	display.poligonos[0].cordenadas3d[0].y = mundo.ymax;
	display.poligonos[0].cordenadas3d[1].y = mundo.ymin;

	display.poligonos[1].cordenadas3d[0].x = mundo.xmin;
	display.poligonos[1].cordenadas3d[1].x = mundo.xmax;
...
void __fastcall TForm1::Button8Click(TObject *Sender) {
	...
	display.poligonos[lbPoligonos->ItemIndex].transladar(StrToFloat(edTransladarX->Text), StrToFloat(edTransladarY->Text));
	display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Button9Click(TObject *Sender) {
	...
	display.poligonos[lbPoligonos->ItemIndex].escalonar(StrToFloat(edScalarX->Text), StrToFloat(edScalarY->Text));
	display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::TranslacaoClick(TObject *Sender) {
	...
	if(lbPoligonos->ItemIndex > 2){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(StrToFloat(edTransladarX->Text), StrToFloat(edTransladarY->Text), 0,0,0,0);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::EscalonamentoClick(TObject *Sender) {
	...
	if( lbPoligonos->ItemIndex > 2){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(0, 0, StrToFloat(edScalarX->Text),StrToFloat(edScalarY->Text),0,1);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::RotacaoClick(TObject *Sender){
	...
	if( display.poligonos[lbPoligonos->ItemIndex].tipo != 'E'){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(0, 0, 0,0, StrToFloat(edAnguloZ->Text),2);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::ReflexcimaClick(TObject *Sender) {
	...
	if(display.poligonos[lbPoligonos->ItemIndex].tipo != 'E'){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(0, 0, 0,0,0,3);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::ReflexLadoClick(TObject *Sender) {
	...
	if(display.poligonos[lbPoligonos->ItemIndex].tipo != 'E'){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(0, 0, 0,0,0,4);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::ReflexDiagonalClick(TObject *Sender) {
	...
	if(display.poligonos[lbPoligonos->ItemIndex].tipo != 'E'){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(0, 0, 0,0,0,5);
		display.desenha(Image1->Canvas, mundo, vp, rgTipoReta->ItemIndex);
...
void __fastcall TForm1::Button11Click(TObject *Sender)
{
	if( lbPoligonos->ItemIndex > 2){
		...
		display.poligonos[lbPoligonos->ItemIndex].ComHomogenea(StrToFloat(edTransladarX->Text)
